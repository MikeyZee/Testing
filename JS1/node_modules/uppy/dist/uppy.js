...
var _require2 = require('../core/Utils'),
    emitSocketProgress = _require2.emitSocketProgress,
    getSocketHost = _require2.getSocketHost,
    settle = _require2.settle,
    limitPromises = _require2.limitPromises;
...
},{"../core/Plugin":75,"../core/UppySocket":77,"../core/Utils":78,"../server":128,"es6-promise":33,"tus-js-client":68,"whatwg-fetch":71}],116:[function(require,module,exports){
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
module.exports = function (_Plugin) {
  ...
  function Url(uppy, opts) {
    ...
    _this.client = new RequestClient(uppy, { host: _this.opts.host });
    return _this;
  }
